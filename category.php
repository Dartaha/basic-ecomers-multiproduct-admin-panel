    ...
    <div class="list">
        ...
        <div class="table">
            <center><table border="2">
                ...
                ?>
                    <td><a href="cat_upd.php?id=<?php echo $id?>&work=update"><button>UPDATE</button></a></td>
                    <td><a href="category_add.php?id=<?php echo $id ?>&work=delete"><button>DALETE</button></a></td>
                </tr>
